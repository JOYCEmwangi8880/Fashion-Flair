  ...
  return <div className='border-b border-gray-200 py-6'>
    <div className='container sm:flex justify-between items-center'>
        ...
        <div className='w-full sm:w-[300px] md:w-[70%] relative'>
            ...
            <BsSearchHeartFill className='absolute right-0 top-0 mr-3 mt-3 text-gray-400 ' size={20} />
            ...
            <BiUserCircle />
                ...
                <div className='bg-red-600 rounded-full absolute top-0 right-0 w-[18px] h-[18px] text-[12px] text-white grid place-items-center translate-X-L -translate-y-1'>
                    0
                </div>
                </div>
                <div className='relative'>
